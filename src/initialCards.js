export const initialCards = [
  {
    image: '/game-covers/the_last_of_us.jpg',
  ...
  {
    image: '/game-covers/red_dead_redemption.jpg',
    title: 'Red Dead Redemption 2',
    genres: ['Открытый мир', 'Экшен', 'Война'],
    video: 'https://www.youtube.com/embed/gmA6MrX81z4',
    price: 4200,
    id: 2,
    description:
      'Америка, 1899 год. Эпоха Дикого Запада подходит к концу. Служители закона методично охотятся на остатки банд. Тех, кто не желает сдаться, убивают. После сорвавшегося ограбления банка Артур Морган и другие подручные Датча ван дер Линде вынуждены пуститься в бега. Их банде предстоит участвовать в кражах, грабежах и перестрелках в самом сердце Америки, на неприветливой земле, где каждый день – это борьба за выживание. За ними по пятам идут федеральные агенты и лучшие в стране охотники за головами, а саму банду разрывают внутренние противоречия. Артуру предстоит выбрать, что для него важнее: его собственные идеалы или верность людям, которые его взрастили.',
  },
  {
    image: '/game-covers/life_after.jpg',
    title: 'Жизнь после',
    genres: ['Открытый мир', 'Экшен', 'Война'],
    video: 'https://www.youtube.com/embed/nkjKvIpmDSk',
    price: 3200,
    id: 3,
    description:
      'Сражайтесь и гоняйте по смертельно опасным дорогам постапокалиптической Америки',
  },
  {
